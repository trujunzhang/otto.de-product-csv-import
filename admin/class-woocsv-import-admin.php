...
class woocsv_import_admin
{
	...
	public function menu()
	{
		...
		if (is_admin() &&  ( count( array_intersect($current_role, $allowed_roles)) > 0 || current_user_can( 'manage_options' ) ) ) {
			...
			//main page
			$page = add_menu_page('otto.de Products CSV Import', __('OTTO CSV Import','woocommerce-csvimport') , current($current_role), 'woocsv_import', array($this,'import'), 'dashicons-randomize',
			'58.15011976');			
